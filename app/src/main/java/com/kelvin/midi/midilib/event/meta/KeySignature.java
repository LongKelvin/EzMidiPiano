...
public class KeySignature extends com.kelvin.midi.midilib.event.meta.MetaEvent
{
    ...
    {
        super(tick, delta, com.kelvin.midi.midilib.event.meta.MetaEvent.KEY_SIGNATURE, new VariableLengthInt(2));
    ...
    public static com.kelvin.midi.midilib.event.meta.MetaEvent parseKeySignature(long tick, long delta, MetaEventData info)
    {
